...
switch ($_GET["op"]) {
    ...
    case 'insertar':     
        ...
        $datos = array();
        $datos = $clientes->insertar($Nombres, $Direccion_cliente, $Telefono_cliente, $Cedula, $Correo);
    ...
    case 'actualizar':
        ...
        $Correo = $_POST["Correo"];
        $datos = array();
        $datos = $clientes->actualizar($idClientes, $Nombres, $Direccion_cliente, $Telefono_cliente, $Cedula, $Correo);
        echo json_encode($datos);
        break;
